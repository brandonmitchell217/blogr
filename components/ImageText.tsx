...
const ImageText = ({ title, desc, image }: ImageTextProps) => {
  return (
    <section className="mt-48 mb-0 lg:mb-12 bg-gradient-to-b from-bodyGradientBlue1 to-bodyGradientBlue2 relative z-[1] rounded-bl-[80px] rounded-tr-[80px] md:h-[380px] lg:h-[400px] flex justify-center items-center">
